 ...
 * @generated
 */
public class ResourcesLocalServiceClp implements ResourcesLocalService {
    ...
    public ResourcesLocalServiceClp(InvokableLocalService invokableLocalService) {
